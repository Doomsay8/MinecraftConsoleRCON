...
<html>
  <head>
    ...
    <title>Votre Console RCON</title>
    ...
    <div id="consoleRow">
      ...
      <div class="input-group" id="consoleCommand">
        ...
        <div class="input-group-btn">
          <button type="button" class="btn btn-primary" id="btnSend"><span class="glyphicon glyphicon-send"></span><span class="hidden-xs"> Envoyé</span></button>
